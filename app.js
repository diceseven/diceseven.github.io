...
var config = {
  ...
  recaptcha_sitekey: '6LdfUCETAAAAAFAMU4LUOVMcRLzi6SoTHEbwp4Ve',  // <----- EDIT ME!
  redirect_uri: 'https://diceseven.github.io',
        ...
        el.div(
          ...
          el.div(
            ...
            el.button(
              ...
              'Tails ', worldStore.state.hotkeysEnabled ? el.kbd(null, 'L') : ''
            )
          )
        );
    } else {
